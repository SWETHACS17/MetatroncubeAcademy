                                                ...
                                                <div className="courses__details-inner">
                                                    ...
                                                    <div className="event-details-list">
                                                        <ul className="list-wrap">
                                                            <li><i className="fas fa-check-circle" />SEO – Rank higher & attract organic traffic</li>
                                                            <li><i className="fas fa-check-circle" />SMM – Social media growth strategies</li>
                                                            <li><i className="fas fa-check-circle" />PPC & Google Ads – Maximize paid marketing ROI</li>
                                                            <li><i className="fas fa-check-circle" />Email & WhatsApp Marketing – Convert leads into customers</li>
                                                            <li><i className="fas fa-check-circle" />SEM – Search engine marketing for instant visibility</li>
                                                            <li><i className="fas fa-check-circle" />Analytics & Conversion Optimization</li>
                                                        </ul>
                                                    </div>
                                                </div> 
                                            </div>
