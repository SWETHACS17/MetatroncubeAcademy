                                                ...
                                                <div className="courses__details-inner">
                                                    ...
                                                    <div className="event-details-list">
                                                        <ul className="list-wrap">
                                                            <li><i className="fas fa-check-circle" />Adobe Premiere Pro – Professional video editing techniques</li>
                                                            <li><i className="fas fa-check-circle" />After Effects – Motion graphics & special effects</li>
                                                            <li><i className="fas fa-check-circle" />CapCut Pro & VN – Quick & creative mobile editing</li>
                                                            <li><i className="fas fa-check-circle" />Audio Synchronization & Sound Design</li>
                                                            <li><i className="fas fa-check-circle" />Color Correction & Cinematic Transitions</li>
                                                            <li><i className="fas fa-check-circle" />Content Creation for YouTube & Social Media</li>
                                                        </ul>
                                                    </div>
                                                </div> 
                                            </div>
