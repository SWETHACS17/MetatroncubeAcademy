        ...
        <>
            ...
            <Layout headerStyle={3} footerStyle={1}>
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="courses__breadcrumb-content">
                                    <Link href="#" className="category">Videography</Link>
                                    <h3 className="title">Video Editing</h3>
                                    <p>Turn raw footage into cinematic experiences that captivate and inspire!! From YouTube videos to cinematic masterpieces, this…</p>
                                    <ul className="courses__item-meta list-wrap">
                                        <li>
                                            <div className="author">
                                                <Link href="#"><img src="/assets/img/courses/empty-logo.jpg" alt="img" style={{height:'43px'}} /></Link>
                                                <Link href="#">Team Metatroncube Academy</Link>
                                            </div>
                                        </li>
                ...
                <section className="courses-details-area section-pb-120">
                    <div className="container">
                        <img src="/assets/img/courses/video-editing.jpg" alt="img" className="courses-details-bg" style={{marginTop:'55px', height:'500px'}} />
                        <div className="row">
                                    ...
                                    <div className="tab-content" id="myTabContent">
                                        <div className={activeIndex === 1 ? "tab-pane active" : "tab-pane"}>
                                            <div className="courses__details-content">
                                                <p>Turn raw footage into cinematic experiences that captivate and inspire!!</p>
                                                <p>From YouTube videos to cinematic masterpieces, this course covers everything from video cutting to special effects, making you an expert editor.</p>
                                                <ui>
                                                    <li>Edit, Enhance & Elevate Your Video Content!</li>
                                                    <li>Create Stunning Visual Stories That Captivate!</li>
                                                    <li>Master the Art of Cinematic Editing!</li>
                                                </ui>
                                                <div className="courses__details-inner">
                                                    <h3 className="title">What Will You Learn?</h3>
                                                    <div className="event-details-list">
                                                        <ul className="list-wrap">
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle"  />Adobe Premiere Pro – Professional video editing techniques</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />After Effects – Motion graphics & special effects</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />CapCut Pro & VN – Quick & creative mobile editing</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Audio Synchronization & Sound Design</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Color Correction & Cinematic Transitions</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Content Creation for YouTube & Social Media</li>
                                                        </ul>
                                                    </div>
                                                </div> 
                                            </div>
