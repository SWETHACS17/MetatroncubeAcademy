                                ...
                                <div className="col-xl-5 col-lg-6">
                                    <div className="about__title-wrap">
                                        <div className="section__title">
                                            ...
                                            <h2 className="title tg-svg" style={{fontSize: '2rem'}}>Building Careers with <span className="position-relative"><span className="svg-icon" id="about-svg" data-svg-icon="assets/img/icons/title_shape.svg" /> Industry-Ready </span>  Skills </h2>
                                        </div>
                                        <p className="fw-medium" style={{fontSize: '17.5px', fontWeight: '500'}}>At Metatron Cube Academy, we believe in empowering individuals with skills that make a difference!!</p>
                                        <p style={{fontSize: '15.9px', fontWeight: '200'}}>
                                            As an extension of Metatron Software Solutions, we bring years of
                                            expertise in Digital Marketing, Web Development, and Tech
                                            Solutions to our academy. Our goal is to bridge the gap between
