                                                ...
                                                <div className="courses__details-inner">
                                                    ...
                                                    <div className="event-details-list">
                                                        <ul className="list-wrap">
                                                            <li><i className="fas fa-check-circle" />Adobe Photoshop – Photo editing & manipulation</li>
                                                            <li><i className="fas fa-check-circle" />Adobe Illustrator – Vector art & logo design</li>
                                                            <li><i className="fas fa-check-circle" />Canva – Quick & easy design for social media</li>
                                                            <li><i className="fas fa-check-circle" />Inkscape & GIMP – Open-source graphic design tools</li>
                                                            <li><i className="fas fa-check-circle" />Typography, Color Theory & Branding Essentials</li>
                                                            <li><i className="fas fa-check-circle" />Social Media & Print Media Design</li>
                                                        </ul>
                                                    </div>
                                                </div> 
                                            </div>
