        ...
        <>
            ...
            <Layout headerStyle={3} footerStyle={1}>
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="courses__breadcrumb-content">
                                    <Link href="#" className="category">Design</Link>
                                    <h3 className="title">Graphic Design</h3>
                                    <p>Turn Your Imagination into Stunning Visuals! Unlock your creativity with professional design tools and techniques. Learn how…</p>
               ...
               <section className="courses-details-area section-pb-120">
                    <div className="container">
                        <img src="/assets/img/courses/graphic-design-1.jpg" alt="img" className="courses-details-bg"  style={{marginTop:'55px', height:'500px'}} />
                        <div className="row">
                                   ...
                                   <div className="tab-content" id="myTabContent">
                                        <div className={activeIndex === 1 ? "tab-pane active" : "tab-pane"}>
                                            <div className="courses__details-content">
                                                <h6>Turn Your Imagination into Stunning Visuals!</h6>
                                                <p>Unlock your creativity with professional design tools and techniques. Learn how to create breathtaking logos, branding materials, and social media graphics that stand out.</p>
                                                <ui>
                                                    <li>Design Like a Pro – Unleash Your Creativity!</li>
                                                    <li>Master the Tools Behind Every Great Design!</li>
                                                    <li>Create Eye-Catching Graphics That Sell!</li>
                                                    <li>Master Adobe Photoshop, Illustrator, and Canva</li>
                                                    <li>Typography, color theory & design principles</li>
                                                    <li>Build a strong portfolio & land creative gigs</li>
                                                </ui>
                                                <h6>Your Creativity, Your Brand – Elevate Your Skills Now!</h6>
                                                <div className="courses__details-inner">
                                                    <h3 className="title">What Will You Learn?</h3>
                                                    <div className="event-details-list">
                                                        <ul className="list-wrap">
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Adobe Photoshop – Photo editing & manipulation</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Adobe Illustrator – Vector art & logo design</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Canva – Quick & easy design for social media</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Inkscape & GIMP – Open-source graphic design tools</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Typography, Color Theory & Branding Essentials</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Social Media & Print Media Design</li>
                                                        </ul>
                                                    </div>
                                                </div> 
                                            </div>
