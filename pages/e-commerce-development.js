        ...
        <>
            ...
            <Layout headerStyle={3} footerStyle={1}>
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="courses__breadcrumb-content">
                                    <Link href="#" className="category">E-Commerce</Link>
                                    <h3 className="title">E-Commerce Development</h3>
                                    <p>Build and Scale Online Businesses Like a Pro! Learn to set up and manage online stores using…</p>
                                    <ul className="courses__item-meta list-wrap">
                                        <li>
                                            <div className="author">
                                                <Link href="#"><img src="/assets/img/courses/course_author02.png" alt="img" style={{height:'43px'}}/></Link>
                ...
                <section className="courses-details-area section-pb-120">
                    <div className="container">
                        <img src="/assets/img/courses/e-commerce.jpg" alt="img" className="courses-details-bg"  style={{marginTop:'55px', height:'500px'}} />
                        <div className="row">
                                   ...
                                   <div className="tab-content" id="myTabContent">
                                        <div className={activeIndex === 1 ? "tab-pane active" : "tab-pane"}>
                                            <div className="courses__details-content">
                                                <h6>Build and Scale Online Businesses Like a Pro!</h6>
                                                <p>Learn to set up and manage online stores using top e-commerce platforms like Shopify and WooCommerce. This course teaches you how to build, optimize, and market your online store successfully.</p>
                                                <ui>
                                                    <li>Store setup, payment gateways & product management</li>
                                                    <li>SEO & digital marketing strategies for e-commerce</li>
                                                    <li>Scaling and automation for long-term success</li>
                                                    <li>Launch Your Own Online Store from Scratch</li>
                                                    <li>Create, Manage & Grow a Successful E-Commerce Brand</li>
                                                    <li>Master the Top Platforms for Online Selling</li>
                                                </ui>
                                                <h6>Turn Clicks into Customers – Start Your E-Commerce Journey!</h6>
                                                <div className="courses__details-inner">
                                                    <h3 className="title">What Will You Learn?</h3>
                                                    <div className="event-details-list">
                                                        <ul className="list-wrap">
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Shopify – Setup, customization & store management</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />WooCommerce – WordPress-based online stores</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />BigCommerce – Scalable e-commerce solutions</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Payment Gateway & Checkout Optimization</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Product Listing, SEO & Marketing Automation</li>
                                                            <li style={{fontSize:'17px'}}><i className="fas fa-check-circle" />Dropshipping & Scaling Strategies</li>
                                                        </ul>
                                                    </div>
                                                </div> 
                                            </div>
