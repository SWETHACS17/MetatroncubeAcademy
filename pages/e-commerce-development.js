                                                ...
                                                <div className="courses__details-inner">
                                                    ...
                                                    <div className="event-details-list">
                                                        <ul className="list-wrap">
                                                            <li><i className="fas fa-check-circle" />Shopify – Setup, customization & store management</li>
                                                            <li><i className="fas fa-check-circle" />WooCommerce – WordPress-based online stores</li>
                                                            <li><i className="fas fa-check-circle" />BigCommerce – Scalable e-commerce solutions</li>
                                                            <li><i className="fas fa-check-circle" />Payment Gateway & Checkout Optimization</li>
                                                            <li><i className="fas fa-check-circle" />Product Listing, SEO & Marketing Automation</li>
                                                            <li><i className="fas fa-check-circle" />Dropshipping & Scaling Strategies</li>
                                                        </ul>
                                                    </div>
                                                </div> 
                                            </div>
